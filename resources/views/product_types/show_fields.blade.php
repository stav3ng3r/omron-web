...
<tr>
    ...
    <td style="text-align: right">{{ $productType->id }}</td>
</tr>
...
<tr>
    ...
    <td style="text-align: right">{{ $productType->descripcion }}</td>
</tr>
...
<tr>
    ...
    <td style="text-align: right">{{ $productType->fecha_creacion }}</td>
</tr>
...
<tr>
    ...
    <td style="text-align: right">{{ $productType->fecha_actualizacion }}</td>
</tr>
