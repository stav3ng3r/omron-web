...
<tr>
    ...
    <td style="text-align: right">{{ $userType->id }}</td>
</tr>
...
<tr>
    ...
    <td style="text-align: right">{{ $userType->descripcion }}</td>
</tr>
...
<tr>
    ...
    <td style="text-align: right">{{ $userType->fecha_creacion }}</td>
</tr>
...
<tr>
    ...
    <td style="text-align: right">{{ $userType->fecha_actualizacion }}</td>
</tr>
